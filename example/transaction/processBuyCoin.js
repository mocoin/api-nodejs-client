...
async function main() {
    ...
    const buyCoinService = new mocoinapi.service.transaction.BuyCoin({
    ...
    const transaction = await buyCoinService.start({
    ...
    // await buyCoinService.cancel(transaction);
    // console.log('取引を中止しました。');

    console.log('取引を確定します...');
    await buyCoinService.confirm(transaction);
    console.log('取引確定です。');
}
